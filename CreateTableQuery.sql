...
(
 ...
 CONSTRAINT [FK_74] FOREIGN KEY ([CampaignID])  REFERENCES [dbo].[Campaigns]([Id]) ON UPDATE CASCADE ON DELETE CASCADE,
 CONSTRAINT [FK_77] FOREIGN KEY ([UserID])  REFERENCES [dbo].[Users]([Id]) ON UPDATE CASCADE ON DELETE CASCADE,
 CONSTRAINT [UK_100] UNIQUE NONCLUSTERED ([CampaignID] ASC, [UserID] ASC)
);
GO

---- CAMPAIGN COMMENTS / CAMPAIGN
--ALTER TABLE [dbo].[CampaignComments]  WITH CHECK ADD  CONSTRAINT [FK_74] FOREIGN KEY([CampaignID])
--REFERENCES [dbo].[Campaigns] ([Id])
--ON UPDATE CASCADE
--ON DELETE CASCADE
--GO
 
--ALTER TABLE [dbo].[CampaignComments] CHECK CONSTRAINT [FK_74]
--GO

---- CAMPAIGN COMMENTS / USER
--ALTER TABLE [dbo].[CampaignComments]  WITH CHECK ADD  CONSTRAINT [FK_77] FOREIGN KEY([UserID])
--REFERENCES [dbo].[Users] ([Id])
--ON UPDATE CASCADE
--ON DELETE CASCADE
--GO
 
--ALTER TABLE [dbo].[CampaignComments] CHECK CONSTRAINT [FK_77]
--GO
...
(
 ...
 CONSTRAINT [FK_62] FOREIGN KEY ([EventID])  REFERENCES [dbo].[Events]([Id]) ON UPDATE CASCADE ON DELETE CASCADE,
 CONSTRAINT [FK_65] FOREIGN KEY ([UserID])  REFERENCES [dbo].[Users]([Id]) ON UPDATE CASCADE ON DELETE CASCADE,
 CONSTRAINT [UK_101] UNIQUE NONCLUSTERED ([UserID] ASC, [EventID] ASC)
);
GO
...
(
 ...
 CONSTRAINT [FK_47] FOREIGN KEY ([CategoryID]) REFERENCES [dbo].[Categories]([Id]) ON UPDATE CASCADE ON DELETE CASCADE
);
GO
